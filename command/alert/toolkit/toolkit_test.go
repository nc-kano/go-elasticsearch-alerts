	...
	for _, tc := range cases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			case "password-set-in-env":
				_ = os.Setenv(EnvEmailAuthPassword, "random-password")
				defer func() {
					_ = os.Unsetenv(EnvEmailAuthPassword)
				}()
			case "username-set-in-env":
				_ = os.Setenv(EnvEmailAuthUsername, "test@gmail.com")
				defer func() {
					_ = os.Unsetenv(EnvEmailAuthUsername)
				}()
			default:
			}
